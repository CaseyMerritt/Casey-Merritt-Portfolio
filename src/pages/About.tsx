        ...
        <div className='w-full flex items-center py-16 bg-gradient-to-r from-cyan-500 to-teal-500'>
            <div className='max-w-[1240] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                 ...
                 <div className=''>
                    <Image className='m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center hover:scale-105 ease-in duration-200' src={'../../public/profile.png'} width={324} height={432} loading='lazy' alt=''></Image>
                 </div>
            </div>
        </div>
    )
