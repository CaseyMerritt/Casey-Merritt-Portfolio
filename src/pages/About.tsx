...
const About = () =>{
    return(
        <div id='about' className='w-full h-screen flex items-center py-16 bg-gradient-to-r from-cyan-500 to-teal-500'>
            <div className='max-w-[1240] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    ...
                    <p className='text-md px-10 py-2 leading-8 text-white'>6 years of both professional and personal devleopment experience</p>
                 </div>
                 <div className=''>
