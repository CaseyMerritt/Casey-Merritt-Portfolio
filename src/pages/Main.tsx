                ...
                <div>
                    ...
                    <div className='flex justify-center py-5 gap-10'>
                        <div className='hover:scale-105 ease-in duration-200'>
                            <a className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md' href='' download>
                                Hire Me
                            </a>
                        </div>
                        <div className='hover:scale-105 ease-in duration-200'>
                            <a className='bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-4 py-2 rounded-md' href='/../public/CaseyMerrittResume.pdf' download>
                                Resume
                            </a>
                        </div>
                    </div>
